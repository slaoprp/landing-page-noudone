        ...
        <div class="container-fluid container-fluid--cp-150">
            ...
            <b-collapse class="default-nav justify-content-center"  is-nav id="nav_collapse">
                <b-navbar-nav class="navbar-nav main-menu text-white">
                    ...
                    <b-nav-item href="#products-section" class="scroll"><span>PRODUCTS</span></b-nav-item>
                    <b-nav-item href="#discount-section" class="scroll"><span>DISCOUNT</span></b-nav-item>
                    <b-nav-item href="#sign-up-section" class="scroll"><span>SIGN UP</span></b-nav-item>
                </b-navbar-nav>
            </b-collapse>
